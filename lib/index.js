...
registerPopoverHandlers = function() {
	...
	jQuery( document ).on( 'keyup', 'textarea.translation', function() {
		var textareasWithInput,
			$form = jQuery( this ).parents( 'form.ct-existing-translation,form.ct-new-translation' ),
	...
	jQuery( document ).on( 'submit', 'form.ct-existing-translation,form.ct-new-translation', function() {
